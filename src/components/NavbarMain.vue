    ...
    <nav class="nav-bar">
      ...
      <div class="popup-content" @click.stop>
        ...
        <form @submit.prevent="login" class="form-control">
          ...
          <!-- Input เบอร์โทรศัพท์ -->
          <label for="phone" class="text-form">เบอร์โทรศัพท์</label>
          <input class="input-form" type="tel" id="phone" v-model="phone" required @input="validateInput">
          ...
          <input class="input-form" :type="showPassword ? 'text' : 'password'" id="password" v-model="password" required>
...
export default {
  ...
  methods: {
    ...
    validateInput(){
      this.showValidationError = !/^[0-9]+$/.test(this.phone)
    },
  }
};
</script>
