...
<template>
    <div class="grid px-10 mt-3 ml-5 mr-5" >
      <div class="col-12 lg:col-12 border">
        <div class="text-center font-bold text-4xl">ข้อมูลโรงแรม</div>
        ...
        <Column field="image_url" class="" header="รูปภาพ" style="width: 10%;"> </Column>
