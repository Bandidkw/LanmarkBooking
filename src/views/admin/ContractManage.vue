    ...
    <template v-slot:header>
      ...
      <div class="grid mt-2 " style="border: 1px solid #ccc;">
        ...
        <div class="col-12 md:col-12 px-3">
          ...
          <p  style="text-indent: 2.5em;">หนังสือสัญญาการเป็นคู่ค้าฉบับนี้(ข้อตกลง) กระทำขึ้นเมื่อวันที่ 22 พฤศจิกายน พ.ศ.2560</p>
          <p style="text-indent: 2.5em;">1.นายกรวิทย์ บัวครั้น เลขที่บัตรประจำตัวประชาชน 1029000643262 ที่อยู่ 16/330 In the memory apartment set รัชดาภิเษก แยก 9-11 แขวงจันเกษม เขตจตุจักร จังหวัดกรุงเทพมหานคร รหัสไปรษณี 10900 (ต่อไปนี้เรียกว่า คู่ค้าฝ่ายที่ หนึ่ง)</p>
          <p style="text-indent: 2.5em;">(2) นายศุภัคกิตต์ ใจเย็น เลขที่บัตรประจำตัวประชาชน 357990000330 ที่อยู่ 103 หมู่ที่ 4 ถนนรอบเมืองเชียงใหม่ ตำบลสุ เทพ อำเภอเมืองเชียงใหม่ จังหวัดเชียงใหม่ รหัสไปรษณี 50200 (ต่อไปนี้เรียกว่า “คู่ค้าฝ่ายที่สอง”)</p>
          <p style="text-indent: 2.5em;">โดยสู้ค่าฝ่ายที่สอง มีความประสงค์ขอที่พัฒนาและดูแลแก้ไขปรับปรุง ปัญหาต่างๆเกี่ยวกับเว็บไซด์ของ lanmark.com เข้าร่วมเป็นพันธมิตรทางการค้า ตาม lanmark.com กำหนดขอบเขตหน้าที่
             จนกว่าจะเลิกจ้าง โดยไม่เปิดเผยข้อมูลของ lanmark.com. ให้แก่บุคคลภายนอกโดยไม่ได้รับความยินยอม ซึ่งต่อไปในสัญญานี้จะเรียกว่า คู่ค้า โดย คู่ค้า
              จะต้องปฏิบัติ ตามหลักเกณฑ์เงื่อนไข หรือนโยบายที่ ภายใต้ชื่อ lanmark.com กำหนดอย่างเคร่งครัด</p>
          <p style="text-indent: 2.5em;">โดยที่คู่ค้าฝ่ายที่สองเป็นผู้พัฒนาแพลตฟอร์มช้อปปิ้งออนไลน์ ตามสัญญาจ้างจนกว่าจะบอกเลิกสัญญาภายใต้ชื่อเรียกว่า แลนมาร์กดอทคอม "lanmark.com" ซึ่งเป็นผู้รวบรวม สินค้าและบริการต่างๆ</p>
          <!--สัญญา-->
          <h3  style="text-indent: 1em;">คู่สัญญาทั้งสองฝ่ายตกลงทำสัญญานี้เพื่อผูกพันระหว่างกันตามข้อกำหนดและเงื่อนไข ดังต่อไปนี้</h3>
          <!---ข้อ 1 -->
          ...
          <p style="text-indent: 4em;">1.3 เพื่อให้คู่ค้าสัญญา ทราบถึง บทบาท หน้าที่ และข้อจำกัดต่างๆ และสิทธิอันพึงมีภายใต้สัญญาฉบับนี้</p>
          <p style="text-indent: 4em;">1.4 เพื่อให้คู่สัญญา ทราบถึงข้อกำหนดและเงื่อนไขต่างๆ ของการปฏิบัติต่อกัน ในฐานะคู่สัญญา ฉบับนี้</p>
          <!---ข้อ 2 -->
          <p style="text-indent: 2.5em;font-weight: bold;">2.ขอบเขตการดำเนินงานของคู่ค้า</p>
          <p style="text-indent: 4em;">คู่ค้าจะพัฒนาระบบเว็บไซต์ระบบการชำระเงินการอัพเดตเว็ปไซต์เว็ปไซต์ส้มและดูแลเกี่ยวกับปัญหาต่างๆของเว็บไซต์ตามสัญญาจ้างที่ได้ตกลงกันไว้ต่างๆ</p>
          <!---ข้อ 3 -->
          ...
          <p style="text-indent: 4em;">หนังสือสัญญาการเป็นคู่ค้านี้มีอายุ 150 วัน ซึ่งมีผลบังคับใช้ตั้งแต่ 22 พฤศจิกายน และพิจารณาการต่ออายุทุกๆ 150 วัน หลัง หมดสัญญา โดยคู่ค้ามีสิทธิอันพึงบอกเลิกสัญญาได้คราวโตคราวหนึ่ง โดยไม่จจำเป็นต้องแจ้งให้ทราบล่วงหน้า</p>
          <!---ข้อ 5 -->
          <p style="text-indent: 2.5em;font-weight: bold;">5.การเปลี่ยนแปลงสัญญา</p>
          <p style="text-indent: 4em;">Lanmark.comขอสงวนสิทธิในการเปลี่ยนแปลงสัญญาตามที่เห็นสมควรโดยlanmark.com จะแจ้งเป็นลายลักษณ์อักษรให้ คู่ค้าทราบก่อนเริ่มการเปลี่ยนแปลงไม่น้อยกว่า 30 วัน โดยสัญญาจะมีผลก็ต่อเมื่อ ทั้งสองฝ่าย ได้ต่างเห็นชอบและมีการลงนามในสัญญาร่วมกัน ทั้ง "lanmark.com" และ "คู่ค้า” เป็นที่เรียบร้อย</p>
          <!---ข้อ 6 -->
          <p style="text-indent: 2.5em;font-weight: bold;">6.หน้าที่เมื่อคู่ค้าเมื่อสัญญาสิ้นสุดลง</p>
          <p style="text-indent: 4em;">เมื่อคู่ค้าได้รับการแจ้งจากทาง lanmark.com ว่าสัญญานี้ได้สิ้นสุดลงไม่ว่าด้วยเหตุผลใด คู่ค้าต้องนำสื่อต่างๆที่เกี่ยวกับคู่ค้า ทุกอย่างภายในการบริการของคู่ค้าออกภายใน 7 วัน
             จะถือว่าผู้ค้ามีเจตนาที่จะทำให้ลูกค้าเกิดความสับสน เข้าใจผิด เกี่ยวข้องกับกิจการของ lanmark.com ทั้งนี้ไม่เกินกว่ามูลค่าความเสียหายที่เกิดขึ้นจริง และ lanmark.com พิสูจน์ความ เสียหายนั้นได้จริง กรณีคู่สัญญาฝ่ายใดฝ่ายหนึ่ง 
             ละเมิดข้อตกลงหรือไม่ปฏิบัติตามเงื่อนไขข้อหนึ่งข้อใดในสัญญาการเป็นคู่ค้า
             ฉบับนี้ อีกฝ่ายหนึ่งมีสิทธิบอกเลิกสัญญาและ/หรือมีความเสียหายเกิดขึ้น คู่สัญญาฝ่ายที่ผิดเงื่อนไขต้องรับผิดชอบชดใช้ ค่าเสียหายที่เกิดขึ้นเท่ากับความเสียหายที่เกิดขึ้น
          </p>
          <!--- -->
