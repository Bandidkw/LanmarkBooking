<template>
  <div class="grid px-10 mt-3 ml-5 mr-5">
    <div class="col-12 lg:col-12 border">
      <div class="text-center font-bold text-4xl">สิ่งที่หน้าสนใจ</div>
      ...
      >
        ...
        <Column field="name" header="สถานที่แนะนำ" style="width: 20%"></Column>
        <Column
          field="description"
          class=""
          header="รายละเอียด"
    ...
    const getData = async () => {
      try {
        const productResponse = await axios.get(
          `${process.env.VUE_APP_API}hotel/highlight`,
          {
            headers: {
