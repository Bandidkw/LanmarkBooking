  ...
  <div class="grid px-10 mt-3 ml-5 mr-5 w-full">
    <div class="col-12 lg:col-12 border">
      ...
      <DataTable :value="Array.isArray(item_product) ? item_product : []" :paginator="true" :rows="20"
        ...
        <Column field="member_id.name" header="ชื่อพาร์ทเนอร์" style="width: 14%"></Column>
        ...
        <Column class="" header="สถานะอนุมัติ" style="width: 25%">
          <template #body="{ data }">
            <div class="sm:w-8  md:w-6 xl:w-5 bg-red-500 flex justify-content-center"
              style="  border-radius: 1rem; padding: 0.5rem;" v-if="data.status === false">
              <div class="font-bold" style="color: #fff;">
                ยังไม่ได้ยืนยันสัญญา
              </div>
            </div>
            <div class="sm:w-8  md:w-6 xl:w-5  bg-green-500 flex justify-content-center"
              style="  border-radius: 1rem; padding: 0.5rem;" v-if="data.status === true">
    ...
    <div class="grid mt-2 " style="border: 1px solid #ccc;">
      ...
      <div class="col-12 md:col-12 px-3">
        ...
        <p style="text-indent: 2.5em;">หนังสือสัญญาการเป็นคู่ค้าฉบับนี้(ข้อตกลง) กระทำขึ้นเมื่อวันที่ 22 พฤศจิกายน
          พ.ศ.2560</p>
        <p style="text-indent: 2.5em;">1.นายกรวิทย์ บัวครั้น เลขที่บัตรประจำตัวประชาชน 1029000643262 ที่อยู่ 16/330 In the
          memory apartment set รัชดาภิเษก แยก 9-11 แขวงจันเกษม เขตจตุจักร จังหวัดกรุงเทพมหานคร รหัสไปรษณี 10900
          (ต่อไปนี้เรียกว่า คู่ค้าฝ่ายที่ หนึ่ง)</p>
        <p style="text-indent: 2.5em;">(2) นายศุภัคกิตต์ ใจเย็น เลขที่บัตรประจำตัวประชาชน 357990000330 ที่อยู่ 103 หมู่ที่
          4 ถนนรอบเมืองเชียงใหม่ ตำบลสุ เทพ อำเภอเมืองเชียงใหม่ จังหวัดเชียงใหม่ รหัสไปรษณี 50200 (ต่อไปนี้เรียกว่า
          “คู่ค้าฝ่ายที่สอง”)</p>
        ...
        <p style="text-indent: 4em;">เมื่อคู่ค้าได้รับการแจ้งจากทาง lanmark.com ว่าสัญญานี้ได้สิ้นสุดลงไม่ว่าด้วยเหตุผลใด
          คู่ค้าต้องนำสื่อต่างๆที่เกี่ยวกับคู่ค้า ทุกอย่างภายในการบริการของคู่ค้าออกภายใน 7 วัน
