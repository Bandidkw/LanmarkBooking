...
<template>
  <div class="body-container">
    ...
    <!-- Popup Content -->
    <div ref="popupContent" @animationend="onAnimationEnd" class="{ 'popup-content': true, 'fade-out': !showPopup } flex p-2 bg-white" style="flex-direction: column; align-items: center; border-radius: 1rem; width: 400px;">
